    ...
    <?php
        ...
        foreach($lesLignes as $keyLigne=>$ligne){
          ...
          echo '<tr>';
            ...
            echo '<button type="submit" name="supprimeLigne"><img src="data:image/png;base64,"></button>';
            echo '<input type="hidden" name="indexLigne" id="supprLigne" value="'. $keyLigne .'">
            </form> </td>';
          echo '</tr>';
        }
    ?>
